...
export const REDIS_KEYS = {
	...
	SERIES_QUEUE_ZSET: 'series-queue',
	SERIES_QUEUE_ACTIVE: 'series-queue-active',
	SERIES_QUEUE_KICK_LOCK: 'series-queue-kick-lock',
} as const
...
export const DEFAULTS = {
	...
	SERIES_QUEUE_ACTIVE_TTL_SEC: 1800,
	SERIES_QUEUE_KICK_LOCK_TTL_SEC: 15,
...
export const ENV = {
	...
	SERIES_QUEUE_ACTIVE_TTL_SEC: parseIntEnv(
		process.env.SERIES_QUEUE_ACTIVE_TTL_SEC,
		DEFAULTS.SERIES_QUEUE_ACTIVE_TTL_SEC
	),
	SERIES_QUEUE_KICK_LOCK_TTL_SEC: parseIntEnv(
		process.env.SERIES_QUEUE_KICK_LOCK_TTL_SEC,
		DEFAULTS.SERIES_QUEUE_KICK_LOCK_TTL_SEC
	),
